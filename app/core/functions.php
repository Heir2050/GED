...
function message(string $msg = null, bool $clear = false)
{
    ...
    if (!empty($msg)) {
        $ses->set('message', $msg); // it check if th message was given and save it
    } else
    if (!empty($ses->get('message'))) { // If there is no message given, that mean the user need to read the message
...
/** displays check boxes values after a page refresh **/
...
/** displays input values after a page refresh (For text) **/
...
/** displays buttons values after a page refresh **/
...
function remove_images_from_content($content, $folder = "uploads/")
{
    ...
    if (!file_exists($folder)) {
        ...
        file_put_contents($folder . "index.php", "Access Denied!"); // In case if someone want to check your upload folder
    }
...
// Get icons file extensions
if (!function_exists('getFileIcon')) {
    function getFileIcon($filename) {
        return \Core\FileHelper::getIcon($filename);
    }
}
...
//         case 'pdf':
//             return '<svg class="fill-current text-red-500" width="32" height="32" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/></svg>';
//         case 'doc':
//         case 'docx':
//             return '<svg class="fill-current text-blue-500" width="32" height="32" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/></svg>';
//         case 'xls':
//         case 'xlsx':
//             return '<svg class="fill-current text-green-500" width="32" height="32" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/></svg>';
//         case 'jpg':
//         case 'jpeg':
//         case 'png':
//         case 'gif':
//             return '<svg class="fill-current text-yellow-500" width="32" height="32" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/></svg>';
//         default:
//             return '<svg class="fill-current text-gray-500" width="32" height="32" viewBox="0 0 24 24"><path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z"/></svg>';
//     }
// }
