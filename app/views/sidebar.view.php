        ...
        <nav x-data="{selected: $persist('Dashboard')}">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="<?= ROOT ?>/document" onclick="markAllNotificationsAsRead()" @click="selected = (selected === 'Calendar' ? '':'Calendar')" class="menu-item group" :class=" (selected === 'Calendar') && (page === 'calendar') ? 'menu-item-active' : 'menu-item-inactive'">
                    ...
                    <li>
                        <a href="<?= ROOT ?>/document/archives" @click="selected = (selected === 'Calendar' ? '':'Calendar')" class="menu-item group" :class=" (selected === 'Calendar') && (page === 'calendar') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg fill="#000000" height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 491.52 491.52" xml:space="preserve"><g><g><path d="M0,37.334v417.095h120.737V37.334H0z M33.361,75.287h54.015v125.488H33.361V75.287z M60.369,416.475 c-14.916,0-27.008-12.091-27.008-27.008c0-14.915,12.091-27.007,27.008-27.007s27.008,12.091,27.008,27.007C87.376,404.384,75.285,416.475,60.369,416.475z"/></g></g>
