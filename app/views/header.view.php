...
<header x-data="{menuToggle: false}" class="sticky top-0 z-99999 flex w-full border-gray-200 bg-white lg:border-b dark:border-gray-800 dark:bg-gray-900">
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div class="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
            ...
            <!-- Dans votre header.view.php -->
            <!-- <div class="hidden lg:block">
                <form id="global-search-form" method="GET" action="<?= ROOT ?>/search">
                    <div class="relative">
                    ...
                    <?php if ($ses->is_logged_in()) : ?>
                        <div>
                            <span class="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">
                                <?= ucfirst($ses->user('prenom')) ?> <?= ucfirst($ses->user('nom')) ?>
                            </span>
                        ...
                        <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                            <li>
                                <a href="<?= ROOT ?>/profile" class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                        ...
                        <a href="<?= ROOT ?>/logout" class="group text-theme-sm mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
...
<div id="notif-modal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.3); z-index:99999; align-items:center; justify-content:center;">
    <div style="background:white; border-radius:10px; max-width:400px; width:90%; margin:auto; padding:2rem; position:relative;">
        <button id="notif-modal-close" style="position:absolute; top:10px; right:10px; font-size:1.5rem; background:none; border:none; cursor:pointer;">&times;</button>
        <h3 id="notif-modal-title" style="font-size:1.2rem; font-weight:bold; margin-bottom:1rem;">Détail de la notification</h3>
        <div id="notif-modal-content" style="margin-bottom: 1.5rem;"></div>
        <a id="notif-details-link" href="#" class="bg-gray-800 text-white p-2 rounded-lg">
            Plus de détails
        </a>
    </div>
</div>
